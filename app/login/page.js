...
const Login = () => {
  ...
  return (<>
    <main className="w-full h-screen flex flex-col items-center pt-10 px-4">
      <div className="max-w-sm w-full text-gray-600 space-y-8">
        <div className="text-center text-white">
          <img src="/a.png" width={150} className="mx-auto" />
        ...
        <div className="space-y-4 text-sm font-medium">
          <button className="w-full flex items-center justify-center gap-x-3 py-2.5 border bg-white rounded-lg ">
            <svg
              className="w-5 h-5"
              viewBox="0 0 48 48"
              fill="none"
          ...
          <button className="w-full flex items-center justify-center gap-x-3 bg-white py-2.5 border rounded-lg ">
            <svg
              className="w-5 h-5"
              viewBox="0 0 48 48"
              fill="none"
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg bg-white"
          >
            <svg
              className="w-5 h-5"
              viewBox="0 0 48 48"
